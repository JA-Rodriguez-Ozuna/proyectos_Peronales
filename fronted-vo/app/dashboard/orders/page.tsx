...
import { ChevronDown, ChevronRight, Filter, X, Eye, Plus } from "lucide-react"
...
const orders: OrderItem[] = [
  ...
  },
  {
    ...
    date: "01/6/2026",
    amount: "$1200 USD",
    paymentDate: "01/6/2026",
    status: "Terminado",
    statusColor: "bg-green-100 text-green-800",
    type: "vfx",
    assignedTo: "María García",
    items: [
      { name: "Video Corporativo", quantity: 1, assignedPayment: 800 },
      { name: "Motion Graphics", quantity: 1, assignedPayment: 300 },
    ],
  },
]
